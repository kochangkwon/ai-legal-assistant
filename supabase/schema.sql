-- AI Legal Assistant - Supabase 스키마
...
-- precedent_cache: 공개 읽기 (캐시는 모든 사용자가 공유)
...
CREATE INDEX IF NOT EXISTS idx_precedent_cache_expires ON precedent_cache(expires_at);
